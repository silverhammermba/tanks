...
tanks: main.o tank.o projectile.o tread.o turret.o wall.o particle.o helpers.o
	g++ -o launch main.o helpers.o tank.o projectile.o tread.o turret.o wall.o particle.o -lBox2D -lsfml-graphics -lsfml-window -lsfml-system
