...
tanks: main.o tank.o projectile.o tread.o helpers.o
	g++ -o launch main.o helpers.o tank.o projectile.o tread.o -lBox2D -lsfml-graphics -lsfml-window -lsfml-system
...
tank.o: tank.cpp tank.hpp helpers.o projectile.o tread.o
